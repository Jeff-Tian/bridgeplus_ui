...
$(document).ready(function(){function o(){$(".mask .text").each(function(){function o(){console.log("image load",this),a.css("width",s[0].width+"px"),a.css("min-height",s[0].height+"px")}var a=$(this),s=a.next(".image");o(),s.load(o)}),$(".mask .close.button").click(function(){var o=$(this).closest(".mask");o.hide();var a=o.find("video");a.length&&a[0].pause()}),$(".mask").css("background-color","rgba(0, 0, 0, 0.4)").css("padding-left",0).hide(),$(".mask.darker").css("background-color","rgba(0, 0, 0, 0.8)"),console.log("hided modals: ",$(".mask").length),$("[data-modal-selector]").on("click",function(o){var a=$(this),s=a.attr("data-modal-selector"),e=$(s);e.css("display","flex"),o.stopPropagation()}),console.log("modals prepared.")}o(),$(document).on("pjax/done",function(){setTimeout(o,100)}),window.modals={prepare:o}});
...
$(function(){function t(){c.currentW=$(window).width(),c.currentH=$(window).height(),a=.5*c.currentW,u=.5*c.currentH}function e(){c.currentH/780}function o(t){return t.classList||(t.getAttribute("class")||"").split(" ")}function n(){var t=Math.max(document.documentElement.clientHeight,window.innerHeight||0);console.log(t);var e=$(".to-top").outerHeight();console.log(e);var o=$("#footer").outerHeight();console.log(o);var n=t-e-o;console.log(n),$("#index-footer").parent().height(n)}function i(){$(".owl-carousel").owlCarousel({items:1,lazyLoad:!0,loop:!0,autoplayTimeout:8e3,autoplayHoverPause:!0,nav:!0,navRewind:!0,smartSpeed:500,navText:['<i class="" style="font-family: cursive;">&lt;</i>','<i class="" style="font-family: cursive;">&gt;</i>'],autoHeight:!0})}function r(){n(),setTimeout(i,500)}var a,u,c={currentW:0,currentH:0};!function(){function t(){function t(){var e=i.clone().attr({r:r,opacity:0,fill:"none","stroke-width":1});return e.attr({opacity:1}).animate({r:r+10,"stroke-width":41,stroke:"#FFF"},1e3,">",function(){}),r+=40,a+150>r?void setTimeout(t,50):($("#logo").addClass("active"),$(".logo_top").addClass("active"),void setTimeout(function(){BridgeWheel.start()},500))}var e=this.intro=new Raphael("bridge_plus_intro",c.currentW,c.currentH),n=e.path("M 0,"+c.currentH+" L 0,"+c.currentH).attr({fill:"#E71E30",stroke:"#E71E30","stroke-width":4}),i=e.circle(a,u,0).attr({fill:"#111",stroke:"#111"});n.animate({path:"M 0,"+c.currentH+" L "+a+","+u},1e3,">",function(){o.arcouno(),n.animate({path:"M "+a+","+u+"L "+a+","+u},1e3,">",function(){}),i.animate({r:"72"},1800,">",function(){}),setTimeout(t,1100)});var r=0}function e(){var t=o.intro.path(o.arc([a,u],120,120,320)).attr({stroke:"#111","stroke-width":1});t.attr({transform:"r0,"+a+","+u}).animate({transform:"r360,"+a+","+u},4e3)}var o=window.INTRO={intro:null,init:t,arcouno:e,arc:function(t,e,o,n){for(var i=o,r=this.toCoords(t,e,i),a="M "+r[0]+" "+r[1];n>=i;)r=this.toCoords(t,e,i),a+=" L "+r[0]+" "+r[1],i++;return a},toCoords:function(t,e,o){var n=o/180*Math.PI,i=t[0]+Math.cos(n)*e,r=t[1]+Math.sin(n)*e;return[i,r]}}}(),function(){var t=window.BridgeWheel={first:!0,sourceArr:[],imgAll:[],init:function(){INTRO.init()},evHandlers:function(){},start:function(){t.resize();var e=new Raphael("bridge_plus_wheel",2e3,1e3);e.wheel(440,vmvideos.slice(32,51),2,vmvideos,[],additionInfo)},resize:e}}(),$(window).on("resize",function(){t(),BridgeWheel.resize()});var s=$(".wheel_text"),l=$(".main_page_wheel"),h=$(".main_page_bottom"),f=$(".main_page_right");$(document).on("wheel/show",function(){$(".svg_group").hover(function(){$(document).trigger("show_group_desc",o(this))},function(){$(document).trigger("hide_group_desc",o(this))}).on("click",function(){var t,e=o(this);e.value.indexOf("svg_group_0")>=0&&(t="/portal/zh/student-portal"),e.value.indexOf("svg_group_1")>=0&&(t="/portal/zh/mentor-portal"),e.value.indexOf("svg_group_2")>=0&&(t="/portal/zh/hr-portal"),$(document).trigger("navigate",t)})}).on("click",".logo_right",function(){$(document).trigger("show_right")}).on("show_group_desc",function(t,e,o){s.hide().each(function(){$(this).hasClass(o)&&$(this).show()})}).on("hide_group_desc",function(t,e,o){s.each(function(){$(this).hasClass(o)&&$(this).hide()})}).on("show_wheel",function(){l.animate({top:0,left:0},500),h.animate({top:"100%",left:0},500),f.animate({left:"100%"},500)}).on("show_content",function(){l.animate({top:"-100%",left:0},500),h.animate({top:0,left:0},500),f.animate({left:"100%"},500),r()}).on("show_right",function(){l.animate({left:"-100%"},500),h.animate({left:"-100%"},500),f.animate({left:0},500)}).on("pjax/done",document,function(){$(document).trigger("show_content",null),"function"==typeof i&&setTimeout(i,100),"function"==typeof modals.prepare&&setTimeout(modals.prepare,100)}),t(),BridgeWheel.init(),BridgeWheel.evHandlers(),$(document).on("resize",r),0===location.pathname.indexOf("/portal/")&&$(document).trigger("show_content")});
