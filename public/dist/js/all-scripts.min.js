...
!function(){function t(t,n,e,o,i){if(d.indexOf(t)>=0&&d.indexOf(n)>=0)return o;var r=s.indexOf(t),a=s.indexOf(n);return 0>r||0>a||r===a?e:a>r?o:i}function n(t){t.css({position:"absolute",left:"100%",right:"-100%"})}function e(t){t.animate({left:"-100%",right:"100%"},"slow",function(){t.remove()})}function o(t){return t.animate({left:"0",right:"0"},"slow",function(){t.css("position","relative")}).promise()}function i(t){t.css({position:"absolute",left:"-100%",right:"100%"})}function r(t){t.animate({left:"100%",right:"-100%"},"slow",function(){t.remove()})}function a(t,n){var e=document.createElement("div");e.innerHTML=t.innerHTML;var o=$(e),i=$(t);o.css({position:"absolute",left:"0",right:"0"}),o.insertBefore(i),n&&n(o,i)}function c(){$("#footer").css("position","fixed")}function u(){$("#footer").css("position","relative")}function l(t,i){c(),n(t),e(i),o(t).done(u)}function f(t,n){c(),i(t),r(n),o(t).done(u)}var s=["/portal/zh/about-us","/portal/zh/team","/portal/zh/video","/portal/zh/contact-us","/portal/zh/join-us"],d=["/portal/zh/student-portal","/portal/zh/mentor-portal","/portal/zh/hr-portal"];window.animationDirector={returnToOriginalPos:o,cloneOldSlide:a,getAnimation:t,slideToLeft:l,slideToRight:f}}(),$(function(){function t(t,n){t.push(n),t.length>5&&t.shift()}function n(t,n,e){o(n,e,function(){f.classList.add("hide"),setTimeout(function(){f.innerHTML=t,f.classList.remove("hide")},100)})}function e(){f=f||document.querySelector(".body"),s=s||document.querySelector("title")}function o(t,n,o){$(document).trigger("pjax/refresh"),e(),o(),r(n,t),$(document).trigger("pjax/done"),console.log("pjax/done")}function i(t,n,e){o(n,e,function(){animationDirector.cloneOldSlide(f,function(n,e){f.innerHTML=t,animationDirector.slideToLeft(e,n)})})}function r(t,n){Object.keys(t).forEach(function(n){f.setAttribute("data-"+n,t[n])}),s&&(s.innerHTML=n)}function a(t,n,e){o(n,e,function(){animationDirector.cloneOldSlide(f,function(n,e){f.innerHTML=t,v(e,n)})})}function c(t){for(var n={},e=t.length-1;e>=0;e--){var o=t[e];0==o.name.indexOf("data-")&&(n[o.name.slice(5)]=o.value)}return n}function u(t,n){console.log("getting ",t),0===t.indexOf("/")&&t.indexOf("//")<0&&(t=location.origin+t),g[t]?(console.log("from cache"),n(g[t])):(console.log("from server"),$.get(t,function(e){g[t]=e,n(e)}))}function l(e,o,i,r){$(document).trigger("pjax/start"),u(e,function(a){f=f||document.querySelector(".body"),s=s||document.querySelector("title"),d.innerHTML=a,i&&(history.pushState(e,"",e),t(m,f.innerHTML),t(p,c(f.attributes)),s&&t(h,s.innerHTML));var u=d.querySelector(".body"),l=d.querySelector("title");(r=r||n)(u.innerHTML,l&&l.innerHTML,c(u.attributes),o)})}var f,s,d=document.createElement("DIV"),m=[],p=[],h=[],g={};document.addEventListener("click",function(t){var e=t.target;if("A"!==e.nodeName){if(e=$(e).closest("a"),!e.length)return!0;e=e[0]}var o=e.href?e.href.toLowerCase():"";return"false"!==e.getAttribute("use-pjax")&&o.length&&"#"!=o.charAt(0)&&0!=o.indexOf("mailto:")&&0!=o.indexOf("javascript:")?(t.preventDefault(),t.stopPropagation(),void l(o,e,!0,animationDirector.getAnimation(location.pathname,e.pathname,n,i,a))):!0},!1),window.addEventListener("popstate",function(){return m&&m.length?void n(m.pop(),h.pop(),p.pop()):void l(location.href)}),$(document).on("navigate",function(t,n){l(n,null,!0)});var v=animationDirector.slideToRight});
