...
$(function(){function r(r){return $('.popup[for="'+$(r.currentTarget).attr("id")+'"]')}var t=function(t){return function(n){if(0===$(".menu.active").length){var e=r(n);e[t]("active")}}};$(".popup-trigger").hover(t("addClass"),t("removeClass"))});
