...
!function(){function t(t,n,e,o,i){if(d.indexOf(t)>=0&&d.indexOf(n)>=0)return o;var r=f.indexOf(t),a=f.indexOf(n);return 0>r||0>a||r===a?e:a>r?o:i}function n(t){t.addClass("slide-to-left"),o(t)}function e(t){return t.animate({left:"0",right:"0"},"slow",function(){t.css("position","relative")}).promise()}function o(t){setTimeout(function(){t.remove()},s)}function i(t){t.addClass("slide-to-right"),o(t)}function r(t,n){var e=document.createElement("div");e.innerHTML=t.innerHTML;var o=$(e),i=$(t);o.css({position:"absolute",left:"0",right:"0",height:i.height()+"px","background-color":i.css("background-color")}),o.insertBefore(i),n&&n(o,i)}function a(){$("#footer").css("position","fixed")}function c(){setTimeout(function(){$("#footer").css("position","relative")},s)}function u(t,e){a(),n(e),t.addClass("return-to-origin-from-right"),setTimeout(function(){t.removeClass("return-to-origin-from-right")},s),c()}function l(t,n){a(),i(n),t.addClass("return-to-origin-from-left"),setTimeout(function(){t.removeClass("return-to-origin-from-left")},s),c()}var s=1e3,f=["/portal/zh/about-us","/portal/zh/team","/portal/zh/video","/portal/zh/contact-us","/portal/zh/join-us"],d=["/portal/zh/student-portal","/portal/zh/mentor-portal","/portal/zh/hr-portal"];window.animationDirector={returnToOriginalPos:e,cloneOldSlide:r,getAnimation:t,slideToLeft:u,slideToRight:l}}(),$(function(){function t(t,n){t.push(n),t.length>5&&t.shift()}function n(t,n,e){o(n,e,function(){s.classList.add("hide"),setTimeout(function(){s.innerHTML=t,s.classList.remove("hide")},100)})}function e(){s=s||document.querySelector(".body"),f=f||document.querySelector("title")}function o(t,n,o){$(document).trigger("pjax/refresh"),e(),o(),r(n,t),$(document).trigger("pjax/done"),console.log("pjax/done")}function i(t,n,e){o(n,e,function(){animationDirector.cloneOldSlide(s,function(n,e){s.innerHTML=t,animationDirector.slideToLeft(e,n)})})}function r(t,n){Object.keys(t).forEach(function(n){s.setAttribute("data-"+n,t[n])}),f&&(f.innerHTML=n)}function a(t,n,e){o(n,e,function(){animationDirector.cloneOldSlide(s,function(n,e){s.innerHTML=t,v(e,n)})})}function c(t){for(var n={},e=t.length-1;e>=0;e--){var o=t[e];0==o.name.indexOf("data-")&&(n[o.name.slice(5)]=o.value)}return n}function u(t,n){console.log("getting ",t),0===t.indexOf("/")&&t.indexOf("//")<0&&(t=location.origin+t),p[t]?(console.log("from cache"),n(p[t])):(console.log("from server"),$.get(t,function(e){p[t]=e,n(e)}))}function l(e,o,i,r){$(document).trigger("pjax/start"),u(e,function(a){s=s||document.querySelector(".body"),f=f||document.querySelector("title"),d.innerHTML=a,i&&(history.pushState(e,"",e),t(m,s.innerHTML),t(g,c(s.attributes)),f&&t(h,f.innerHTML));var u=d.querySelector(".body"),l=d.querySelector("title");(r=r||n)(u.innerHTML,l&&l.innerHTML,c(u.attributes),o)})}var s,f,d=document.createElement("DIV"),m=[],g=[],h=[],p={};document.addEventListener("click",function(t){var e=t.target;if("A"!==e.nodeName){if(e=$(e).closest("a"),!e.length)return!0;e=e[0]}var o=e.href?e.href.toLowerCase():"";return"false"!==e.getAttribute("use-pjax")&&o.length&&"#"!=o.charAt(0)&&0!=o.indexOf("mailto:")&&0!=o.indexOf("javascript:")?(t.preventDefault(),t.stopPropagation(),void l(o,e,!0,animationDirector.getAnimation(location.pathname,e.pathname,n,i,a))):!0},!1),window.addEventListener("popstate",function(){return m&&m.length?void n(m.pop(),h.pop(),g.pop()):void l(location.href)}),$(document).on("navigate",function(t,n){l(n,null,!0)});var v=animationDirector.slideToRight});
