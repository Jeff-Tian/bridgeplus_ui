...
$(document).ready(function(){function o(){function o(o){o.hide();var n=o.find("video");n.length&&n[0].pause()}$(".mask .text").each(function(){function o(){n.css("width",t[0].width+"px"),n.css("min-height",t[0].height+"px")}var n=$(this),t=n.next(".image");o(),t.load(o)}),$(".mask .close.button").click(function(){o($(this).closest(".mask"))}),$(".mask").click(function(){o($(this))}),$(document).on("keydown",function(n){27===n.keyCode&&o($(".mask"))}),$(".mask .shadow-box").click(function(o){o.stopPropagation()}),$(".mask").css("background-color","rgba(0, 0, 0, 0.4)").css("padding-left",0).hide(),$(".mask.darker").css("background-color","rgba(0, 0, 0, 0.8)"),console.log("hided modals: ",$(".mask").length),$("[data-modal-selector]").on("click",function(o){var n=$(this),t=n.attr("data-modal-selector"),a=$(t);a.css("display","flex"),o.stopPropagation()}),console.log("modals prepared.")}o(),$(document).on("pjax/done",function(){setTimeout(o,100)}),window.modals={prepare:o}});
