...
$(function(){function t(t){return $('.popup[for="'+$(t.currentTarget).attr("id")+'"]')}function r(r){var e=t(r);e.css({left:$(r.currentTarget).offset().left+"px"}).toggle()}$(".popup-trigger").on("hover click",r)});
