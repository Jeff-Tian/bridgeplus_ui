...
!function(){function o(o,t){$(o).children().each(function(){var o=$(this);o.attr("data-group")&&o.attr("data-group")!==t?o.hide():o.show()})}$(document).on("show_content",function(t,a,s){o(".group-description",s),o(".carousel-items",s),o(".services",s)}).on("click",".mask .close.button",function(){var o=$(this).closest(".mask").removeClass("show"),t=o.find("video");t.length&&t[0].pause()}).on("click","[data-modal-selector]",function(o){$($(this).attr("data-modal-selector")).addClass("show"),o.stopPropagation()})}();
